        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.menu_home:
                        startActivity(new Intent(BookmarkedActivity.this, HomeActivity.class));
                        finish();
                        return true;
                    case R.id.menu_my_courses:
                        startActivity(new Intent(BookmarkedActivity.this, MyCoursesActivity.class));
                        finish();
                        return true;
                    case R.id.menu_profile:
                        startActivity(new Intent(BookmarkedActivity.this, ProfileActivity.class));
                        finish();
                        return true;
                    default:
                        return false;
